...
/* harmony import */ var _modules_tabs_init_tabs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/tabs/init-tabs */ "./js/modules/tabs/init-tabs.js");
/* harmony import */ var _modules_select_custom_select__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/select/custom-select */ "./js/modules/select/custom-select.js");
/* harmony import */ var _modules_form_validate_form__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/form-validate/form */ "./js/modules/form-validate/form.js");
/* harmony import */ var _modules_banner__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/banner */ "./js/modules/banner.js");
/* harmony import */ var _modules_advantages__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/advantages */ "./js/modules/advantages.js");
/* harmony import */ var _modules_main_catalog__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/main-catalog */ "./js/modules/main-catalog.js");
/* harmony import */ var _modules_where__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/where */ "./js/modules/where.js");
/* harmony import */ var _modules_video__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/video */ "./js/modules/video.js");
/* harmony import */ var _modules_up__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/up */ "./js/modules/up.js");
/* harmony import */ var _modules_line__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/line */ "./js/modules/line.js");
/* harmony import */ var _modules_detail__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./modules/detail */ "./js/modules/detail.js");
/* harmony import */ var _modules_recipe__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./modules/recipe */ "./js/modules/recipe.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_header__WEBPACK_IMPORTED_MODULE_2__["headerInit"])();
  Object(_modules_banner__WEBPACK_IMPORTED_MODULE_6__["bannerInit"])();
  Object(_modules_advantages__WEBPACK_IMPORTED_MODULE_7__["advantagesInit"])();
  Object(_modules_recipe__WEBPACK_IMPORTED_MODULE_14__["recipeInit"])();
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_tabs_init_tabs__WEBPACK_IMPORTED_MODULE_3__["initTabs"])();
    Object(_modules_main_catalog__WEBPACK_IMPORTED_MODULE_8__["mainCatalogInit"])();
    Object(_modules_where__WEBPACK_IMPORTED_MODULE_9__["whereInit"])();
    Object(_modules_video__WEBPACK_IMPORTED_MODULE_10__["videoInit"])();
    Object(_modules_up__WEBPACK_IMPORTED_MODULE_11__["upInit"])();
    Object(_modules_line__WEBPACK_IMPORTED_MODULE_12__["lineInit"])();
    Object(_modules_detail__WEBPACK_IMPORTED_MODULE_13__["detailInit"])();
    var select = new _modules_select_custom_select__WEBPACK_IMPORTED_MODULE_4__["CustomSelect"]();
    select.init();
    var form = new _modules_form_validate_form__WEBPACK_IMPORTED_MODULE_5__["Form"]();
    window.form = form;
    form.init();
  });
});
...
/*!**********************************!*\
  !*** ./js/modules/advantages.js ***!
  \**********************************/
/*! exports provided: advantagesInit */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "advantagesInit", function() { return advantagesInit; });
function advantagesInit() {
  var advantagesSliders = document.querySelectorAll('.advantages__slider');
  if (advantagesSliders.length) {
    advantagesSliders.forEach(function (advantagesSlider) {
      var swiper = new Swiper(advantagesSlider, {
        // Navigation arrows
        navigation: {
...
/*!******************************!*\
  !*** ./js/modules/banner.js ***!
  \******************************/
/*! exports provided: bannerInit */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "bannerInit", function() { return bannerInit; });
function bannerInit() {
  var bannerSliders = document.querySelectorAll('.banner__slider');
  if (bannerSliders.length) {
    bannerSliders.forEach(function (banner) {
...
/*!******************************!*\
  !*** ./js/modules/detail.js ***!
  \******************************/
/*! exports provided: detailInit */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "detailInit", function() { return detailInit; });
function detailInit() {
...
var baseSuccessCallback = function baseSuccessCallback(event) {
  ...
  var formSuccessClose = formSuccess.querySelector('.form__success-close');
  if (formSuccess) {
...
/*!****************************!*\
  !*** ./js/modules/line.js ***!
  \****************************/
/*! exports provided: lineInit */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "lineInit", function() { return lineInit; });
function lineInit() {
  var lineSlider = document.querySelector('.line__slider');
  if (lineSlider) {
    var swiper = new Swiper(lineSlider, {
      // Navigation arrows
      navigation: {
...
/***/ "./js/modules/main-catalog.js":
/*!************************************!*\
  !*** ./js/modules/main-catalog.js ***!
  \************************************/
/*! exports provided: mainCatalogInit */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "mainCatalogInit", function() { return mainCatalogInit; });
function mainCatalogInit() {
  var mainCatalogSlider = document.querySelector('.main-catalog__slider');
  if (mainCatalogSlider) {
    var swiper = new Swiper(mainCatalogSlider, {
      // Navigation arrows
      navigation: {
...
/***/ "./js/modules/recipe.js":
/*!******************************!*\
  !*** ./js/modules/recipe.js ***!
  \******************************/
/*! exports provided: recipeInit */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "recipeInit", function() { return recipeInit; });
function recipeInit() {
  var recipeSliders = document.querySelectorAll('.recipe__slider');
  if (recipeSliders.length) {
    recipeSliders.forEach(function (recipe) {
...
/*!**************************!*\
  !*** ./js/modules/up.js ***!
  \**************************/
/*! exports provided: upInit */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "upInit", function() { return upInit; });
function upInit() {
  var footerUp = document.querySelector('.footer__up');
  if (footerUp) {
...
/*!*****************************!*\
  !*** ./js/modules/video.js ***!
  \*****************************/
/*! exports provided: videoInit */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "videoInit", function() { return videoInit; });
function videoInit() {
...
/*!*****************************!*\
  !*** ./js/modules/where.js ***!
  \*****************************/
/*! exports provided: whereInit */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "whereInit", function() { return whereInit; });
function whereInit() {
  var whereShopsDivisionShops = document.querySelectorAll('.where__shops-division-shops');
  if (whereShopsDivisionShops.length && document.documentElement.clientWidth < 768) {
    whereShopsDivisionShops.forEach(function (shopSlider) {
